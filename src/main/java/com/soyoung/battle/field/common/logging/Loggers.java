...
package com.soyoung.battle.field.common.logging;
...
//    }
    ...
    /**
     * Just like {@link #( Class ,  String...)} but String loggerName instead of
     * Class.
     */
...
//        }
    ...
    public static Logger getLogger(Logger parentLogger, String s) {
        ...
        return BFLoggerFactory.getLogger(((PrefixLogger)parentLogger).prefix(), parentLogger.getName() + s);
    }

    public static Logger getLogger(String s) {
        return BFLoggerFactory.getLogger(s);
    }

    public static Logger getLogger(Class<?> clazz) {
        return BFLoggerFactory.getLogger(clazz);
    }

    public static Logger getLogger(Class<?> clazz, String... prefixes) {
        return BFLoggerFactory.getLogger(formatPrefix(prefixes), clazz);
    }

    public static Logger getLogger(String name, String... prefixes) {
        return BFLoggerFactory.getLogger(formatPrefix(prefixes), name);
    }
