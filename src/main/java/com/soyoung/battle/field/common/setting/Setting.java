...
import com.soyoung.battle.field.common.collect.Tuple;
import com.soyoung.battle.field.common.unit.ByteSizeValue;
import com.soyoung.battle.field.common.unit.MemorySizeValue;
 ...
 * together with {@link }. This class contains several utility methods that makes it straight forward
...
public class Setting<T> {
    ...
    private T get(Settings settings, boolean validate) {
        ...
        try {
            ...
            return parsed;
        } catch (BattlefieldParseException ex) {
