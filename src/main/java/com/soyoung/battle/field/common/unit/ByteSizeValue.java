...
package com.soyoung.battle.field.common.unit;



import com.soyoung.battle.field.BattlefieldParseException;
...
//    }
    ...
    public static ByteSizeValue parseBytesSizeValue(String sValue, String settingName) throws BattlefieldParseException {
    ...
    public static ByteSizeValue parseBytesSizeValue(String sValue, ByteSizeValue defaultValue, String settingName)
            throws BattlefieldParseException {
        ...
        if (lowerSValue.endsWith("k")) {
            ...
            // Missing units:
            throw new BattlefieldParseException(
...
//                            initialInput, settingName);
                    ...
                    throw new BattlefieldParseException("failed to parse [{}]", e, initialInput);
                }
            }
        } catch (IllegalArgumentException e) {
            throw new BattlefieldParseException("failed to parse setting [{}] with value [{}] as a size in bytes", e, settingName,
                    initialInput);
        }
    }
