...
import com.soyoung.battle.field.cli.SuppressForbidden;
...
import com.soyoung.battle.field.monitor.Probes;
...
public class OsProbe {
    ...
    private final Logger logger = BFLoggerFactory.getLogger(getClass());
