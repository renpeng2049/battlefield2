...
package com.soyoung.battle.field.transport;
...
public class BoundTransportAddress {
    ...
    public static BoundTransportAddress readBoundTransportAddress(InputStream in) throws IOException {
        BoundTransportAddress addr = new BoundTransportAddress();
        //addr.readFrom(in); TODO
        return addr;
    }
